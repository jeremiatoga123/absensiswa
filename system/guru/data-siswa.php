					...
					<div class="col-md-6" align="right">
						<nav>
							<ul class="pagination">
								...
								<a class='page-link' href='page.php?g-data-siswa&kelas=$nm_kelas&pg=' aria-label='Previous'>
								<span aria-hidden='true'>&laquo;</span>
								<span class='sr-only'>Previous</span>
								</a></li> ";
								}
								...
								<a class='page-link' href='page.php?g-data-siswa&kelas=$nm_kelas&pg='aria-label='Next'>
								<span aria-hidden='true'>&raquo;</span>
								<span class='sr-only'>Next</span>
								</a></li>";
								}
